namespace Tutkoo.mintyfusion.Moov.Sdk.Helper
{
    ...
    public class MoovClient : IClient
    {
            ...
            IDictionary<string, string> queryParams = null)
        {
            ...
            {
                // Append base url to make it proper URL otherwise host exception comes
                UriBuilder uriBuilder = new UriBuilder(httpClient.BaseAddress.AbsolutePath + endpoint);
                ...
                // Remove base url address once query params are added
                endpoint = endpoint.Replace(httpClient.BaseAddress.AbsolutePath, "");
            }
